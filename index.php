<?php
	...
	$url = "http://localhost/Working-Api/dbConnect.php";	
	$ch = curl_init();
	...
	if($data_respose->output->respone == 1){
		header("Location: https://www.w3schools.com/");//redirct if username and password match
	}
	else{
		echo '<script>alert("Fill Correct Email Id and Password")</script>';
			...
			<div class="wrap-login100 p-l-110 p-r-110 p-t-62 p-b-33">
				<form class="login100-form validate-form flex-sb flex-w" method="post">
					...
					<?php
						...
						echo'<a href="' . $loginUrl . '" class="facebookLoginButton btn-face m-b-20"><i class="fa fa-facebook-official"></i>Facebook</a>';
					?>
					...
					?>	
					<a href="<?php echo $client->createAuthUrl()?>" class="btn-google m-b-20">
						<img src="images/icons/icon-google.png" alt="GOOGLE">
						Google<!--<i class="fa fa-twitter-square" style="font-size:48px;color:blue"></i>-->
					</a>
					
					<a href="<?php echo $client->createAuthUrl()?>" class="btn-google m-b-20">
						<i class="fa fa-twitter-square" style="font-size:48px;color:blue;"></i>&ensp;
						Twitter
					</a>
					
					<a href="#" class="btn-google m-b-20">
						<i class="fa fa-linkedin-square" style="font-size:48px;color:blue;"></i>&ensp;
						LinkedIn
					</a>
